...
const ListItem = ({ done, title, children, onClickTitle, onChangeDone, removeItem, editTitle, className = '', }) => {
    ...
    return ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", { class: 'flex gap-2 items-center min-w-0 ' + className, onSubmit: saveNewTitle, children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { class: "flex items-center justify-center", children: (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", { class: "h-5 w-5 accent-[var(--button-bg-color)]", type: "checkbox", checked: done, onChange: () => onChangeDone({ title, done: !done }) }) }), isEdit ? ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", { class: "grow min-w-0 border border-blue-800 rounded-md text-black", ref: refInput, value: newTitle, onInput: ({ currentTarget }) => setNewTitle(currentTarget.value) })) : ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { class: `grow min-w-0 overflow-clip text-ellipsis ${!done ? '' : 'line-through'}`, onClick: () => onClickTitle({ title }), children: title })), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { class: "min-w-fit flex gap-2 items-center justify-center", children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_base_btn__WEBPACK_IMPORTED_MODULE_11__["default"], { type: "button", draggable: true, children: (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_icons_SvgArrowsUpDown__WEBPACK_IMPORTED_MODULE_13__["default"], { class: "h-6" }) }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_base_btn__WEBPACK_IMPORTED_MODULE_11__["default"], { type: "button", onClick: () => {
