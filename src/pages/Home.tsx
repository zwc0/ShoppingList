    ...
    return (
        <>
            <div class='flex flex-wrap'>
				...
				<svg onClick={()=>setIsDark(!isDark)} class='w-4 h-4 block dark:hidden' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<svg onClick={()=>setIsDark(!isDark)} class='w-4 h-4 hidden dark:block' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
